...
if %errorlevel% neq 0 (
    ...
    if exist "%SCRIPT_DIR%start_scripts\start_web.bat" (
        start "Xiaoyou Web" "%SCRIPT_DIR%start_scripts\start_web.bat"
    ) else (
        echo [ERROR] start_web.bat not found at %SCRIPT_DIR%start_scripts\start_web.bat
